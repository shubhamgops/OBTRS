<%@ Page Title="Reset Password" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="Online_Bus_Ticket_Reservation_System.ResetPassword" %>
 ...
 <table style="width: 100%;">
        <tr>
            <td align="center">
                ...
                <table>
                    <tr>
                    <td> <asp:Label ID="currentpasswdlbl" runat="server" Font-Bold="True" 
                            Font-Italic="True" style="margin-bottom: 10px" Text="Current Password:"></asp:Label></td>

                    <td><asp:TextBox ID="currentpasswdtxt" runat="server" Height="25px" Width="230px" 
                            style="margin-bottom:10px" TextMode="Password"></asp:TextBox></td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ControlToValidate="currentpasswdtxt" ErrorMessage="Required old password" 
